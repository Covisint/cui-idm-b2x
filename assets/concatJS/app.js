...
angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('assets/app/applications/new-request&review/new-request.html',
    ...
    "            \n" +
    "            <div tether class=cui-action__popover target=#cui-applications__requested-apps attachment=\"top middle\" targetattachment=\"bottom left\" offset=\"-20px 50px\" ng-if=newAppRequest.requestPopover>\n" +
  ...
  $templateCache.put('assets/app/common-templates/password-validation.html',
    ...
    "    <div class=cui-error__status ng-class=\"{'cui-error__status--pass':!errros.specialNotAllowed}\"></div>\n" +
    ...
    "</div>\n" +
    "\n" +
    "<div class=cui-error__message>{{'password-rules' | translate:policies}}<br>\n" +
    "    <div class=cui-error__message>\n" +
  ...
  $templateCache.put('assets/app/misc/welcome/welcome.screen.html',
    ...
    "\n" +
    "    \n" +
    "    <div class=cui-styeguide__popover-container ng-if=welcome.divisionPopover off-click=\"welcome.divisionPopover=false\" tether target=#newDivision-header attachment=\"top middle\" target-attachment=\"bottom middle\" offset=\"15px 145\">\n" +
  ...
  $templateCache.put('assets/app/profile/organization/organization.profile.html',
    ...
    "      <h4 class=cui-field-val__field>{{'cui-admins' | translate}}</h4>\n" +
  ...
  $templateCache.put('assets/app/profile/user/sections/address.html',
    ...
    "        <div class=cui-field-val__val>{{base.countries.getCountryByCode(usersEdit.tempUser.addresses[0].country).name}}</div>\n" +
    "      </div>\n" +
    "      \n" +
    ...
    "          </div>\n" +
    "          <div auto-complete input-name=country pause=100 selected-object=usersEdit.userCountry initial-value=base.countries.getCountryByCode(usersEdit.tempUser.addresses[0].country) local-data=base.countries.list search-fields=name title-field=name input-class=cui-input match-class=highlight auto-match=true></div>\n" +
    "        </div>\n" +
    "        \n" +
    ...
    "          <button class=cui-button ng-click=\"usersEdit.updatePerson('address',toggleOff);\">\n" +
    "            <span ng-if=\"!usersEdit.address || !usersEdit.address.submitting\">{{'cui-update' | translate}}</span>\n" +
    "            <div class=cui-loading--medium-ctr ng-if=usersEdit.address.submitting></div>\n" +
    "            <span ng-if=usersEdit.address.error>{{'cui-error-try-again'| translate}}</span>\n" +
    "          </button>\n" +
    "        </div>\n" +
    "      </div>\n" +
    "    </div>\n" +
  ...
  $templateCache.put('assets/app/profile/user/sections/header.html',
    ...
    "    <div class=cui-media__image-container>\n" +
    "      \n" +
    "      <div class=cui-media__image cui-avatar cui-avatar-names=\"[usersEdit.user.name.given, usersEdit.user.name.surname]\" cui-avatar-color-class-prefix=cui-avatar__color cui-avatar-color-count=5></div>\n" +
    "    </div>\n" +
    "    <div class=cui-media__body>\n" +
    "      \n" +
    "      <h3 class=cui-media__title>{{usersEdit.user.name.given}} {{usersEdit.user.name.surname}}</h3>\n" +
    "      \n" +
    "      <p class=cui-media__content--small>{{'cui-registered' | translate}}: {{usersEdit.user.creation | date:base.appConfig.dateFormat}}</p>\n" +
  ...
  $templateCache.put('assets/app/profile/user/sections/password.html',
    ...
    "          <input class=cui-input name=newPassword type=password ng-model=usersEdit.userPasswordAccount.password ng-required=true ng-class=\"{'cui-input--error': password.newPassword.$touched && password.newPassword.$invalid}\" password-validation>\n" +
    "          \n" +
  ...
  $templateCache.put('assets/app/profile/user/sections/timezone-language.html',
    ...
    "        <span class=cui-field-val__val>{{usersEdit.timezoneById(usersEdit.user.timezone)}}</span><br>\n" +
